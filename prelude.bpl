...
procedure {:inline 1} $Dfinance_create_signer(
      addr: $Value
) returns (signer: $Value) {
    // A signer is currently identical to an address.
    signer := addr;
...
procedure {:inline 1} $Dfinance_destroy_signer(
  signer: $Value
) {
  return;
}

procedure {:inline 1} $Event_emit(
    m: $Memory, signer: $Value, msg: $Value
) {
    return;
}

procedure {:inline 1} $U256_from_u8(value: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_from_u64(value: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_from_u128(value: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_as_u8(value: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_as_u64(value: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_as_u128(value: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_add(l: $Value, r: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_sub(l: $Value, r: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_mul(l: $Value, r: $Value) returns (res: $Value) {}

procedure {:inline 1} $U256_div(l: $Value, r: $Value) returns (res: $Value) {}
